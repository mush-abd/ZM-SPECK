...
def inverse_ProcessS(input_array, output_array, output_index, lambda_, input_index, b):
    if input_array[input_index] == 0:
        print('Insignificant set')
        for lambda_i in range(output_index, output_index + lambda_):
            if output_array[output_index] != 0:
                output_array[lambda_i] = output_array[lambda_i] - (2**b)/2  
        ...
        if lambda_ > 4:
            ...
            print(f'next output index: {output_index}')
...
def main():
    ...
    while b >= 0:
        ...
        while output_index < Npix:
            ...
            output_index, lambda_, input_index = inverse_ProcessS(input_array, output_array, output_index, lambda_, input_index, b)
